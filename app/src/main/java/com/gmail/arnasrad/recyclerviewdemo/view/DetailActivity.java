...
public class DetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView dateAndTime = findViewById(R.id.lblDateAndTimeHeader);
        dateAndTime.setText(dateAndTimeExtra);

        TextView message = findViewById(R.id.lblMessageBody);
        message.setText(messageExtra);

        View coloredBackground = findViewById(R.id.imvColoredBackground);
